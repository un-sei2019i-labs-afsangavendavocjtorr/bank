...
public enum TransactionsQueries {
    ...
    TransactionsFields.RECEIVER.getKey()+") references "+Tables.Account_Data.getName()+"("+AccountFields.AC_CODE.getKey()+");"),
    ...
    Add_FK_TRANSMITTER_ACCOUNT_ACCOUNT_DATA("alter table "+Tables.Transactions.getName()+" add constraint FK_TRANSMITTER_ACCOUNT_ACCOUNT_DATA foreign key ("+
            TransactionsFields.TRANSMITTER_ACCOUNT.getKey()+") references "+Tables.Account_Data.getName()+"("+AccountFields.AC_CODE.getKey()+");"),
